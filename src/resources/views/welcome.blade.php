        ...
        <!-- <div class="relative bg-center sm:flex sm:justify-center sm:items-center min-h-screen bg-gray-100 dark:bg-gray-900 selection:bg-red-500 "> -->
            @if (Route::has('login'))
                ...
                <div class="flex justify-end">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="font-semibold text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Dashboard</a>
                    @else
                        ...
                        <button class="bg-white hover:bg-gray-200 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow" onclick="location.href='{{ route('login') }}'" >
                            ログイン
                        </button>
                        ...
                        @if (Route::has('register'))
                            ...
                            <button class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow p-5" onclick="location.href='{{ route('register') }}'" >
                                新規登録
                            </button>
                        @endif
                    @endauth
