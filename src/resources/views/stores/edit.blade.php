            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                  <section class="text-gray-600 body-font relative">
                    <form method="post" action="{{ route('stores.update', ['id' => $store->id]) }}" enctype="multipart/form-data">
                      @csrf
                    <div class="container px-5 py-24 mx-auto">
                      ...
                      <div class="lg:w-1/2 md:w-2/3 mx-auto">
                        <div class="flex flex-wrap -m-2">
                          ...
                          <div class="p-4 w-full border-b-2 border-gray-300">
                            <div class="relative">
                              <label class="leading-7 text-sm text-gray-600" id="twentyfour">営業時間</label><br>
                              <label class="relative inline-flex items-center cursor-pointer">
                              <input type="checkbox" name="twentyfour" id="twentyfour" value="1" @if($store->twentyfour === 1) checked @endif class="sr-only peer">
                              ...
                              <input type="text" id="open" name="open" value="{{ $store->open }}" class="w-10% bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                              〜
                              <label for="close" class="leading-7 text-sm text-gray-600">営業終了</label>
                              <input type="text" id="close" name="close" value="{{ $store->close }}" class="w-10% bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                          </div>
                          ...
                          <div class="p-4 w-full border-b-2 border-gray-300">
                            <div class="relative">
                              ...
                              <label class="relative inline-flex items-center cursor-pointer">
                              <input type="checkbox" name="visitor" id="visitor" value="1" @if($store->visitor === 1) checked @endif class="sr-only peer">
                              <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                          ...
                          <div class="p-4 w-full border-b-2 border-gray-300">
                            ...
                            <div class="relative">
                              ...
                              <label class="relative inline-flex items-center cursor-pointer">
                              <input type="checkbox" name="pool" id="pool" value="1" @if($store->pool === 1) checked @endif class="sr-only peer">
                              <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                            ...
                            <div class="relative">
                              ...
                              <label class="relative inline-flex items-center cursor-pointer">
                              <input type="checkbox" name="sauna" id="sauna" value="1" @if($store->sauna === 1) checked @endif class="sr-only peer">
                              <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                            ...
                            <div class="relative">
                              ...
                              <label class="relative inline-flex items-center cursor-pointer">
                              <input type="checkbox" name="shower" id="shower" value="1" @if($store->shower === 1) checked @endif class="sr-only peer">
                              <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                            ...
                            <div class="relative">
                              ...
                              <label class="relative inline-flex items-center cursor-pointer">
                              <input type="checkbox" name="wifi" id="wifi" value="1" @if($store->wifi === 1) checked @endif class="sr-only peer">
                              <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                          ...
                          <div class="p-4 w-full border-b-2 border-gray-300">
                            ...
                            <div class="relative">
                              ...
                              <input type="text" id="maximum" name="maximum" value="{{ $store->maximum }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">kg
                            </div>
                            <div class="relative">
                              <label for="bench" class="leading-7 text-sm text-gray-600">ベンチの数</label><br>
                              <input type="text" id="bench" name="bench" value="{{ $store->bench }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                            <div class="relative">
                              <label for="rack" class="leading-7 text-sm text-gray-600">パワーラックの数</label><br>
                              <input type="text" id="rack" name="rack" value="{{ $store->rack }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                            ...
                            <div class="relative">
                              ...
                              <input type="text" id="smith" name="smith" value="{{ $store->smith }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                            <div class="relative">
                              <label for="cable" class="leading-7 text-sm text-gray-600">ケーブルの数</label><br>
                              <input type="text" id="cable" name="cable" value="{{ $store->cable }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                            ...
                            <div class="relative">
                              ...
                              <input type="text" id="chestpress" name="chestpress" value="{{ $store->chestpress }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                            <div class="relative">
                              <label for="pec" class="leading-7 text-sm text-gray-600">ペックフライの数</label><br>
                              <input type="text" id="pec" name="pec" value="{{ $store->pec }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                            ...
                            <div class="relative">
                              ...
                              <input type="text" id="armcurl" name="armcurl" value="{{ $store->armcurl }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                            <div class="relative">
                              <label for="triceps" class="leading-7 text-sm text-gray-600">トライセプスエクステンションの数</label><br>
                              <input type="text" id="triceps" name="triceps" value="{{ $store->triceps }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                            ...
                            <div class="relative">
                              ...
                              <input type="text" id="latpull" name="latpull" value="{{ $store->latpull }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                            <div class="relative">
                              <label for="rawing" class="leading-7 text-sm text-gray-600">ローイングの数</label><br>
                              <input type="text" id="rawing" name="rawing" value="{{ $store->rawing }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                            ...
                            <div class="relative">
                              ...
                              <input type="text" id="abcrunch" name="abcrunch" value="{{ $store->abcrunch }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                            ...
                            <div class="relative">
                              ...
                              <input type="text" id="hacksquat" name="hacksquat" value="{{ $store->hacksquat }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                            <div class="relative">
                              <label for="legext" class="leading-7 text-sm text-gray-600">レッグエクステンションの数</label><br>
                              <input type="text" id="legext" name="legext" value="{{ $store->legext }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                            <div class="relative">
                              <label for="legpress" class="leading-7 text-sm text-gray-600">レッグプレスの数</label><br>
                              <input type="text" id="legpress" name="legpress" value="{{ $store->legpress }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                            ...
                            <div class="relative">
                              ...
                              <input type="text" id="maximum" name="tread" value="{{ $store->tread }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                            <div class="relative">
                              <label for="cross" class="leading-7 text-sm text-gray-600">クロストレーナーの数</label><br>
                              <input type="text" id="cross" name="cross" value="{{ $store->cross }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                            <div class="relative">
                              <label for="bike" class="leading-7 text-sm text-gray-600">エアロバイクの数</label><br>
                              <input type="text" id="bike" name="bike" value="{{ $store->bike }}" class="w-50% mr-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">台
                            </div>
                          </div>
