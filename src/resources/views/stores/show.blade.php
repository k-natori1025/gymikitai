        ...
        <div class="p-6 text-gray-900">
          <section class="text-gray-600 body-font relative">
            <div class="container px-5 py-24 mx-auto">
              ...
              <div class="p-2 w-full">
                <button class="flex mx-auto text-white bg-lime-500 border-0 py-2 px-8 focus:outline-none hover:bg-lime-600 rounded text-lg" onclick="location.href='{{ route('comments.create', ['id'=> $store->id]) }}'">このジムの口コミを書く</button>
              </div>
              <div class="p-2 w-full">
