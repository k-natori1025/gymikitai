                      ...
                      <div class="lg:w-1/2 md:w-2/3 mx-auto">
                        <div class="flex flex-wrap -m-2">
                          ...
                          <div class="p-2 w-full">
                            <div class="relative">
                              営業時間
                              <label class="leading-7 text-sm text-gray-600" id="all-day"></label><br>
                              <input type="checkbox" name="allDay" id="all-day" value="1">
                              <label class="leading-7 text-sm text-gray-600" for="all-day">24時間営業</label><br>
                          ...
                          <div class="p-2 w-full">
                            <div class="relative">
                              <label for="price-style" class="leading-7 text-sm text-gray-600">料金</label><br>
                          ...
                          <div class="p-2 w-full">
                            <div class="relative">
                              ダンベルの重さ
                              <label for="max-weight" class="leading-7 text-sm text-gray-600"></label><br>
                              <input type="text" id="max-weight" name="maxWeight" class="w-50% bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">kg
                            </div>
                          </div>
